...
There is a pressing need for a robust, automated solution that can calibrate multiple SCD30 CO<sub>2</sub> sensors simultaneously at the same time in a controlled environment, using a web server interface. 
